...
function SidebarMenuButton({ className, isActive, asChild = false, ...props }: SidebarMenuButtonProps) {
  ...
  // Use Slot from radix-ui instead of React.Fragment for asChild
  const Comp = asChild ? Slot : "button"

  return (
    <Comp
      className={cn(
        "sidebar-menu-button flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm font-medium ring-offset-background transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sidebar-ring focus-visible:ring-offset-2",
